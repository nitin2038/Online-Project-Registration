                            ...
                            <td><table width="100%" border="0" cellpadding="2">
                                    <tbody><tr>
                                        <td colspan="3" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                <tbody><tr>
                                                    <td width="18%" rowspan="3" align="right" valign="top"><img src="imgs/cmrit.jpg" alt="LOGO" width="130" height="123" align="right" style="float:left; padding-left:2%"></td>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"><span class="title1">CMR INSTITUTE OF TECHNOLOGY , BANGALORE </span><br></td>
                                                </tr>
                                                <tr>

        ...
        <nav class="navbar navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">CMR</a>
				</div>
				<div class="collapse navbar-collapse" id="navbar">
					<ul class="nav navbar-nav">
						
                    <li><?php echo "<a href=profile.php?sid=" . $srow["sid"] . ">Profile</a>"; ?></li>
                        ...
                        <div class="well">
                            <div class="settings">
                                <h2 id="white" style="text-decoration:underline;"><?php echo $srow["first_name"]; ?>'s Password</h2>
                                    ...
                                    <br />
                                    <button type="submit" class="update-button btn btn-success"> Update</button>
                                    </form>
                            </div>
                        </div> 
                    </div>

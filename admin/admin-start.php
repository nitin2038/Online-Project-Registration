        ...
        <nav class="navbar navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a href="../index.php" class="navbar-brand">Course Registration</a>
				</div>
				<div class="collapse navbar-collapse" id="navbar">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li><?php echo "<a href='scripts/logout-admin.php'>Logout</a>"; ?></li>
					</ul>
				</div>
			</div>
		</nav>
        ...
        <div class="container">
            ...
            <div id="admin-section">
                <header>
                    ...
                    <a href="viewRegisteredStudents.php"><button class="button">View Registered Courses</button></a>
                    <br /><br />
